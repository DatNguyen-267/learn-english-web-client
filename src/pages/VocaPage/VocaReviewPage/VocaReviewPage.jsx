...
export default function VocaReviewPage() {
  ...
  const autoCompleteQuestion = async () => {
    ...
    await delay(DELAY_NEXT_QUESTION + 500);
        ...
        <div className="grid wide">
          <div className="sub-header-contain">
            <div className="sub-header__left">
              ...
              <div className="sub-header__left-title">Ôn Tập Siêu Tốc</div>
            </div>
            ...
            <div className="rv-pg-bd__head">
              ...
              <div className="rv-pg-bd__pgr-bar">
                <div className="rv-pg-bd__progress">
                  <div
                    className="rv-pg-bd__progress-bar"
                    style={{ width: `${time / TIME_OUT_PERCENT}%` }}
                  ></div>
                </div>
            ...
            <div className="rv-pg-bd__question">
              {lsWord && isEnd === false && lsQuestion && (
                <div>
                  ...
                  ></QuickQuestionABCD>
                  <audio
                    src={`https://600tuvungtoeic.com/audio/${lsWord[count].english}.mp3`}
                    style={{ display: 'none' }}
                    id="rv-pg__audio"
                  ></audio>
                </div>
