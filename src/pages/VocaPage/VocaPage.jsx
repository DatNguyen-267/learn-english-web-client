      ...
      <div className="voca-page">
        <div className="voca-heading">
          <div className="voca-header">
            ...
            <div className="feature">
              <button className="btn btn-exercise" onClick={handleShowReview}>
                Ôn tập siêu tốc
              </button>
            </div>
          </div>
        ...
        <div className="base__group">
          ...
          <div className="topic-list">
            <div className="row">
              {userProcess.voca !== null &&
                voca.data != undefined &&
                voca.data.list_topic.map((item, index) => {
                  let tempUserProcess = userProcess.voca.list_topic.find(
                    (item2, index2) => item2.id_topic === item._id
                  );
