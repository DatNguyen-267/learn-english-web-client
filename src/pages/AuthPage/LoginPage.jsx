...
import { ErrMsg } from '~/components/Common/Notify/Notification';
...
function LoginPage() {
  ...
  const handleLoginClick = async (e) => {
    try {
      ...
      {
        error.response.data.msg && setUser({ ...user, err: error.response.data.msg });
      }
      ...
      <div className="container">
        ...
        <div className="login">
          <form action="">
            ...
            <button className="btn btn-login" type="button" onClick={handleLoginClick}>
              Đăng nhập
            </button>
