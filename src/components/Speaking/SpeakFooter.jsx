...
import "./SpeakFooter.scss"
function SpeakFooter({onClickNext, onClickPre, question_playing, length, list_question}) {
    ...
    return (
        <div class="speak-footer">
            <div class="grid wide speak-footer-content">
